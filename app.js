...
const STEPS = [
  {
    ...
    phase: "Kurulum",
    title: "BMAD Kurulumu",
    desc: "Akademi eğitmen portalı projesinde BMAD'ı tek komutla kurun.",
    command: "npx bmad-method install",
    alias: null,
    prompt: "~/akademi-portal $",
    required: true,
    explain:
      "Proje klasöründe bmad-method yükleyicisini çalıştırır. Modül (bmm), IDE (claude-saka) ve dil tercihlerini sorar. _bmad/ ve _bmad-output/ oluşturur.",
    output: [
      { text: "  ╔══════════════════════════════════════╗", cls: "info" },
      { text: "  ║       BMAD Method Installer          ║", cls: "info" },
      { text: "  ╚══════════════════════════════════════╝", cls: "info" },
      { text: "? Proje: akademi-egitmen-portali", cls: "warn" },
      { text: "? Modüller: core, bmm", cls: "warn" },
      { text: "? AI aracı: claude-saka", cls: "warn" },
      { text: "✓ Kurulum tamamlandı", cls: "success" },
      { text: "→ claude-saka'da projeyi açın", cls: "dim" },
    ],
  },
  {
    tabLabel: "Help",
  ...
  },
  {
    ...
    alias: null,
    prompt: "claude-saka Chat › (yeni chat)",
    optional: true,
...
const OPSX_STEPS = [
  {
    ...
    output: [
      { text: "🔍 Keşif: Mobil Uygulama — gamer segmenti", cls: "info" },
...
const bmadSim = createGuideSimulator({
  ...
  initialHistory: [
    ...
    { text: "Senaryo: Akademi Eğitmen Portalı", cls: "dim" },
    { text: "", cls: "" },
  ],
  restartHistory: [
    { text: "SDD Eğitimi — BMAD Simülasyonu (Akademi)", cls: "info" },
...
const opsxSim = createGuideSimulator({
  ...
  initialHistory: [
    ...
    { text: "Senaryo: Mobil Uygulama — Gamer Ek Paket Ekranı", cls: "dim" },
